...
# Locations of things.
OSTREE=$(HOME)/cs3231/root	# Root directory to install into.
...
# Hack below as some compilers don't recognize (void) foo() and throw an unused result error
HOST_WERROR=$(WERROR) -Wno-error=unused-result
